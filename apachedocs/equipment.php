...
<div class="content-area">
    <table class="data-table">
        ...
        <?php foreach ($equipment as $item): ?>
            <tr>
                <td><?= htmlspecialchars($item['EQPT_ID']); ?></td>
                <td><?= htmlspecialchars($item['EQPT_NAME']); ?></td>
                <td><?= htmlspecialchars($item['EQPT_TYPE']); ?></td>
                <td>
                    <a href="?delete=<?= $item['EQPT_ID']; ?>"
    ...
    <div class="form-container">
        ...
        <form method="post">
            ...
            <button type="submit" name="add_equipment" class="form-submit-button">Добавить</button>
        </form>
    </div>
</div>
