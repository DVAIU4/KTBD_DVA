...
<div class="content-area">
    <table class="data-table">
        ...
        <?php foreach ($components as $component): ?>
            <tr>
                <td><?= htmlspecialchars($component['COMP_ID']); ?></td>
                <td><?= htmlspecialchars($component['COMP_NAME']); ?></td>
                <td><?= htmlspecialchars($component['COMP_TYPE']); ?></td>
                <td><?= htmlspecialchars($component['COMP_DATE']); ?></td>
                <td>
                    <a href="?delete=<?= $component['COMP_ID']; ?>"
    ...
    <div class="form-container">
        ...
        <form method="post">
            ...
            <div class="form-group">
                <label for="co_type">Тип:</label>
                <select id="co_type" name="co_type" required>
            ...
            <div class="form-group">
                <label for="co_date">Дата (ДД.ММ.ГГ):</label>
                <input type="text" id="co_date" name="co_date" required
                       placeholder="ДД.ММ.ГГ"
                       pattern="\d{2}\.\d{2}\.\d{2}"
                       title="Введите дату в формате ДД.ММ.ГГ">
            </div>
            <button type="submit" name="add_component" class="form-submit-button">Добавить</button>
        </form>
    </div>
</div>
